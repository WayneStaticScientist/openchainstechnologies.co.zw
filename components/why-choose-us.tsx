                        ...
                        <div className="row g-4">
                            <div className="col-xl-5 col-lg-4 col-md-6">
                                <div className="choose-us-left-content">
                                    ...
                                    <p className="mt-4 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                                        OpenChains is a leading company specializing in delivering high-quality website services, innovative software solutions, cutting-edge electronics, and more. Our mission is to empower businesses and individuals with reliable, efficient, and tailored solutions that meet their unique needs. With a team of experienced professionals and a commitment to excellence, OpenChains ensures that every project is executed with precision and care, making us a trusted partner for your digital and technological endeavors.
                                    </p>
                            ...
                            <div className="col-xl-3 col-lg-4 col-md-6">
                                <div className="choose-us-img wow img-custom-anim-left">
                                    <img src="/assets/img/choose-us/choose-us.jpg" alt="img" />
                                </div>
                            </div>
                            <div className="col-xl-4 col-lg-4 col-md-6">
                                <div className="choose-us-right">
                                    <h4 className="wow fadeInUp" data-wow-delay=".3s">
                                        Experience the Difference: Choose Us for Your Next Project
                                    </h4>
                                    <p className="wow fadeInUp" data-wow-delay=".5s">
                                        At OpenChains, we pride ourselves on delivering exceptional value to our clients. Our team is dedicated to understanding your unique requirements and providing tailored solutions that drive success. Whether you`re looking for innovative software, reliable electronics, or expert digital services, we are here to exceed your expectations.
                                    </p>
                                    <div className="client-img wow fadeInUp" data-wow-delay=".3s">
                                        <img src="assets/img/choose-us/client-img.png" alt="img" />
                                    </div>
                                    <p className="wow fadeInUp" data-wow-delay=".5s">
