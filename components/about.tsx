                ...
                <div className="about-image wow img-custom-anim-left">
                  ...
                  <div className="about-box float-bob-y">
                    <h2>
                      <span
                        className="odometer"
                        data-count={`${new Date().getFullYear() - 2015}`}
                      >
              ...
              <div className="col-lg-7">
                <div className="about-content">
                  ...
                  <p className="wow fadeInUp mt-4 mt-md-0" data-wow-delay=".5s">
                    OpenChains is a dynamic team of digital innovators dedicated
                    to transforming your ideas into powerful, engaging
                    realities. We specialize in a comprehensive range of digital
                    services{" "}
                  </p>
                  <div
                    className="about-sideber wow fadeInUp"
                    data-wow-delay=".3s"
                  >
                    <h5>
                      “We combine technical expertise with creative vision to
                      deliver exceptional results. Our commitment to innovation
                      and client satisfaction drives us to exceed expectations
                      and build lasting partnerships. We are based in Zimbabwe,
                  ...
                  <div className="about-btn">
                    <Link
                      ...
                      data-wow-delay=".3s"
                    >
                      <span>More About Openchains</span>{" "}
                      <i className="far fa-long-arrow-right"></i>
                    </Link>
                    <div
                      className="group-image wow fadeInUp"
                      data-wow-delay=".5s"
                    >
