...
document.querySelectorAll('.hosting-features-con:not(.shared-hosting-features-con) .feature-box').forEach(box => {
...
document.querySelectorAll('.our-guarantees-con .gunrntee-box').forEach(box => {
  const originalImage = box.querySelector('img').src; // Store the original image URL
